...
<body>
	...
	ArrayList<DetallePedido> lineasPedido2 = (ArrayList<DetallePedido>) request.getAttribute("lineasPedido2");
	pageContext.setAttribute("listaPedido4", lineasPedido2);
	int totalCompra = (int) request.getAttribute("sTotal2");
					...
					<div class="panel-body invoice-body">
						<div class="table-responsive">
							<table class="table table-condensed">
								...
								<c:forEach items="${pageScope.listaPedido4}" var="lineas">
									<tr>
										<td><span><c:out
										...
										<td class="text-right"><span></span> <c:out
												value="${lineas.cantidad}"></c:out></td>
